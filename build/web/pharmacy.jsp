                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="patient" rel="popover" data-original-title="<span style='text-align:center;'> <h3>Patient Information Summary </h3> <h5><%=mgr.getPatientByID(vst.getPatientid()).getFname()%> <%=mgr.getPatientByID(vst.getPatientid()).getLname()%></h5> <h5><b> Date of Birth :</b> <%=mgr.getPatientByID(vst.getPatientid()).getDateofbirth()%></h5> </span>"
                                                                        ...
                                                                        <td> Policy Number </td> <td> <%=mgr.sponsorshipDetails(vst.getPatientid()).getMembershipid()%> </td> </tr> <tr> <td> Benefit Plan </td> <td> <%=mgr.sponsorshipDetails(vst.getPatientid()).getBenefitplan()%> </td> </tr>  </table> "><%=ptPatienttreatments.getTreatment()%> </td>
                                                                    <td> Tablet </td>
...
<!--<div style="max-height: 600px; y-overflow: scroll;"  id="<%=vst.getVisitid()%>_adddrug_dialog" title="Add Drug">
  ...
  <table class="table">
      <tr>
          <td><b>Name of Drug
              ...
              <input type="text" name="drug" class="input" />
          </td>
          <td><b>Type
                  <br />
                  <br />
              </b><select name="type" class="input-small"></select></td>
          <td><b>Quantity
                  <br />
                  <br />
              </b><select name="qty" class="input-small"></select></td>
      </tr>
      <tr>
      ...
      <tr>
          <td colspan="3"><textarea style="width: 95%" name="note"></textarea></td>
      </tr>
  </table>			                           
  <table>
      <tr>
          <td style="text-align: center;">
              <input class="btn-info" type="hidden" name="drugid" value="<%=vst.getVisitid()%>" />
              <input class="btn-info" type="submit" name="adddrug" value=" Add Drug" />
          </td>
          <td style="text-align: center;">
