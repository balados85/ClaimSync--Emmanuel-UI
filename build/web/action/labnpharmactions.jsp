                ...
                if (treatment != null) {
                   // String[] treatments = treatment.split("<>");
                    for (int i = 0; i < treatment.length; i++) {
                        ...
                        mgr.addPatientTreatment(patientid, treatmentcode[1], treatmentcode[0], treatmentcode[4], 0.0, "", id, formatter.format(date), prescriptionnote, qty, treatmentcode[2]);
                ...
                if (diagnosis != null) {
                   // String[] diagnoses = diagnosis.split("<>");
                    for (int i = 0; i < diagnosis.length; i++) {
                        ...
                        mgr.addPatientDiagnosis(patientid, diagnosescode[0], diagnosescode[1], id, formatter.format(date));
                    }
                }
