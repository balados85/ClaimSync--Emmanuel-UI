...
<% try {
        ...
        if ("patient".equals(request.getParameter("action"))) {
            ...
            String dob = request.getParameter("dob") == "" ? "0000-00-00" : request.getParameter("dob");
            ...
            String emergencyContact = request.getParameter("emergency") == "" ? "NA" : request.getParameter("emergency");
            ...
            f = mgr.createFolder(p.getPatientid(), p.getLname().substring(0, 1) + "-0001", "OPD");
            if (f == null) {
