...
public class Patientinvestigation  implements java.io.Serializable {
    ...
    public Patientinvestigation(String patientid, String code, String investigation, String result, double price, int visitationid, String performed, Date date) {
    ...
    public Patientinvestigation(String patientid, String code, String investigation, String result, double price, Integer quantity, int visitationid, String note, String performed, Date date) {
       this.patientid = patientid;
       this.code = code;
       this.investigation = investigation;
       this.result = result;
