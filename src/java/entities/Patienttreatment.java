...
public class Patienttreatment  implements java.io.Serializable {
    ...
    public Patienttreatment(String patientid, String code, String treatment, String dosage, int visitationid, Date date, double price, String dispensed) {
    ...
    public Patienttreatment(String patientid, String code, String treatment, String dosage, int visitationid, Date date, double price, Integer quantity, String type, String note, String dispensed) {
       this.patientid = patientid;
       this.code = code;
       this.treatment = treatment;
       this.dosage = dosage;
